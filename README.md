...
## Publicación
Repo privado en GitHub + hosting en Netlify (dominio **tu-teamuniform.com**, comprado en Namecheap).
...
3. **Configurar el dominio:** en el panel de Netlify, andá a "Domain management" › "Add a domain" e ingresá `tu-teamuniform.com`. Luego apuntá los DNS en Namecheap a los nameservers de Netlify (te los muestra en pantalla).
